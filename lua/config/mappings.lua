...
vim.keymap.set('n', '<leader>bn', ':bfirst<enter>',    { desc = '[B]uffer [F]irst'    })
vim.keymap.set('n', '<leader>bn', ':blast<enter>',     { desc = '[B]uffer [L]ast'     })
vim.keymap.set('n', '<leader>bn', ':bnext<enter>',     { desc = '[B]uffer [N]ext'     })
vim.keymap.set('n', '<leader>bp', ':bprevious<enter>', { desc = '[B]uffer [P]revious' })
